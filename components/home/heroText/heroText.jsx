  ...
  return (
    <div className="w-full h-screen md:h-full flex flex-col px-6 md:px-8 lg:px-12">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="max-w-2xl lg:max-w-xl xl:max-w-2xl lg:pr-8 xl:pr-12">
          {/* Badge / Pill */}
          ...
          {/* Heading */}
          <h1
            className="mt-6 bg-gradient-to-r from-text-primary via-text-primary to-gray-600 bg-clip-text text-transparent text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-semibold leading-[1.05] tracking-tight"
          ...
          {/* Subheading */}
          <p
            className="mt-5 text-lg md:text-xl lg:text-lg xl:text-xl text-text-primary/80 leading-relaxed max-w-xl lg:max-w-lg xl:max-w-xl font-normal"
            style={{ fontFamily: "var(--font-poppins), Poppins, sans-serif" }}
          >
