  ...
  return (
    <div className="group relative bg-white rounded-lg md:rounded-[28px] lg:rounded-[36px] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 cursor-pointer" style={{ aspectRatio: '1 / 0.8' }}>
      ...
      <div className="relative w-full h-full bg-gray-200">
        ...
        <div className="absolute top-6 left-6 right-20 md:bottom-6 md:right-16 md:group-hover:top-6 md:group-hover:bottom-auto md:group-hover:left-6 md:group-hover:right-20 transition-all duration-700 ease-in-out z-10">
          <h3 className="text-white text-xl md:text-2xl font-bold tracking-tight leading-tight drop-shadow-lg transition-all duration-700 ease-in-out">
            {property.name}
          </h3>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 translate-y-0 md:transform md:translate-y-full md:group-hover:translate-y-0 transition-transform duration-700 ease-in-out z-10">
          <div className="mx-4 mb-4">
            {/* Description block - full width */}
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl mb-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-xl p-3 shadow-xl">
                <div className="flex items-center space-x-1">
                  ...
                  <span className="font-medium text-gray-800 text-xs">{habitaciones} Bed</span>
                </div>
              </div>
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-xl p-3 shadow-xl">
                <div className="flex items-center space-x-1">
                  ...
                  <span className="font-medium text-gray-800 text-xs">{ubicacion}</span>
                </div>
              </div>
            </div>
          </div>
